...
namespace ScenarioRunner
{
    ...
    ///     <c>TestRig/DedicatedServer/dev-plugins/</c> next to the dedi launcher, ships as a
        ...
        private void Awake()
        {
            ...
            Scenario = Config.Bind(
                ...
                new ConfigDescription(
                    ...
                    "See TestRig/DedicatedServer/dev-plugins/ScenarioRunner/README.md for the full catalogue."));
