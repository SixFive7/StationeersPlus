...
namespace ClientDriver
{
    ...
    internal static partial class Router
    {
        ...
        private static HttpResponse HostWorld(IDictionary body)
        {
            ...
            bool requireIsolatedSavePath = Json.GetBool(body, "requireIsolatedSavePath", true);
            ...
            var pre = Main(() =>
            {
                ...
                if (requireIsolatedSavePath && !isolated)
                    return HttpResponse.Error(
                        ...
                        "POST /savepath first. requireIsolatedSavePath=false overrides this and " +
                        "writes a world into the developer's own save tree: never pass it.", 409);
