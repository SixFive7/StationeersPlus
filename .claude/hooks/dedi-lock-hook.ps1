# dedi-lock-hook.ps1 -- saved with UTF-8 BOM
# Fires PreToolUse when a command invokes dedicated-server.ps1, or when any
# command or file Read/Edit/Write touches the TestRig/DedicatedServer/ tree.
# Injects the session-lock reminder + the stop-before-deploy rule, and points
# at the single sources of truth (TestRig/DedicatedServer/session.lock.template,
