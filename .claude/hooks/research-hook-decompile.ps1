...
Research/WORKFLOW.md Rule 2 ("curate decompiled-code findings into Research/ on every touch") applies: any game-internals finding you produce this turn must land in a page under Research/<category>/ in this same response, with version stamps set to {0}. Do not postpone. Read Research/WORKFLOW.md in full if you have not yet this conversation.
'@ -f $version
