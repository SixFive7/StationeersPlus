...
| [CHANGELOG.md](CHANGELOG.md) | New top entry. v1.9.0 (visible visual overhaul + new settings); v1.8.0 shipped as the Max Transfer Capacity release. No BepInEx reset caveat: only adding fields, not renaming existing ones. |
