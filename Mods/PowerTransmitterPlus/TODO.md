...
- Test rig rules, including the one session lock that covers both halves: [TestRig/CLAUDE.md](../../TestRig/CLAUDE.md). Operating reference (every verb, the working sequences, the endpoint catalogue): [TestRig/MANUAL.md](../../TestRig/MANUAL.md)
