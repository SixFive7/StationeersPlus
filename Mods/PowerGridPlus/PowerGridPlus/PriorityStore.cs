...
namespace PowerGridPlus
{
    ...
    // its full OutputMaximum sheds for 10 seconds (BrownoutRegistry).
    //
    ...
    internal static class PriorityStore
    {
        ...
        // changes (an IC10 chip writes Priority and then reads Shedding in the same
        ...
        // Also bumped from BrownoutRegistry shed-state changes so a freshly-shed or
        // freshly-released transformer re-allocates immediately, not on next tick.
